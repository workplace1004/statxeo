...
export function NewSupportTicketModal({state: externalState, trigger}: NewSupportTicketModalProps) {
  ...
  function handleSubmit(close: () => void) {
    ...
    notifySuccess("Ticket opened — our partner team will reply within one business day");
    reset();
    close();
  }
          ...
          <Modal.Dialog>
            <Modal.Header>
              ...
              <p className="text-muted text-sm">
                Describe your issue — tracking, payouts, assets, or account access.
              </p>
            </Modal.Header>
            <Modal.Body className="flex flex-col gap-3">
              <TextField isRequired name="subject" value={subject} onChange={setSubject}>
                <Label>Subject</Label>
                <Input placeholder="Payout missing for March" />
              </TextField>
              <Select
                className="w-full"
                name="category"
              ...
              <TextField isRequired name="message" value={message} onChange={setMessage}>
                ...
                <TextArea
                  ...
                  placeholder="Include references, dates, and anything that helps us resolve this faster."
                />
              </TextField>
            </Modal.Body>
            <Modal.Footer>
