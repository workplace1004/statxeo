...
interface CustomerEnvAlertProps {
  title: string
  description: string
}

export function CustomerEnvAlert({ title, description }: CustomerEnvAlertProps) {
  return (
      ...
      <div className="mx-auto flex min-h-[calc(100vh-10rem)] max-w-3xl items-center justify-center">
        <Card className="neo-surface w-full border-white/70 bg-white/80 shadow-[0_28px_80px_rgba(15,23,42,0.12)] backdrop-blur dark:border-white/10 dark:bg-slate-950/75 dark:shadow-[0_28px_90px_rgba(2,6,23,0.55)]">
          <CardHeader className="space-y-4 text-center">
            <div className="mx-auto inline-flex items-center rounded-full border border-cyan-200/80 bg-cyan-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-cyan-700 dark:border-cyan-400/20 dark:bg-cyan-500/10 dark:text-cyan-200">
              Customer portal
            </div>
