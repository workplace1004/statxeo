    ...
    return (
      ...
      >
        {stairs.map((_, index) => (
          ...
          >
            {!bgColor && (
              <div className="w-full h-full bg-white/40 dark:bg-black/40 backdrop-blur-2xl border-x border-black/5 dark:border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.02)]" />
            )}
          </motion.div>
        ))}
        {renderLoadingText()}
    ...
    return (
      ...
      >
        <motion.div
          ...
          className={cn(
            "rounded-full aspect-square backdrop-blur-2xl border border-black/5 dark:border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.02)]",
            bgColor ? "" : "bg-white/40 dark:bg-black/40",
          )}
          style={{
            width: "300vmax",
            height: "300vmax",
  ...
  const renderCurtainVariant = () => {
    ...
    return (
      ...
      >
        ...
        >
          {!bgColor && (
            <div className="w-full h-full bg-white/40 dark:bg-black/40 backdrop-blur-2xl border-r border-black/5 dark:border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.02)]" />
          )}
        </motion.div>
        ...
        >
          {!bgColor && (
            <div className="w-full h-full bg-white/40 dark:bg-black/40 backdrop-blur-2xl border-l border-black/5 dark:border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.02)]" />
          )}
        </motion.div>
        {renderLoadingText()}
      </div>
